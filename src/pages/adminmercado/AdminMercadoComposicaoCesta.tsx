...
export default function AdminMercadoComposicaoCesta() {
  ...
  const [ofertas] = useState<Oferta[]>([
    ...
    },
    {
      ...
      quantidadeDisponivel: 92,
      valorAcumulado: 120.00,
      certificacao: 'convencional',
      tipo_agricultura: 'familiar',
    },
  ]);
  ...
  return (
    ...
    >
        ...
        <Card>
          ...
          <CardContent>
            ...
            <div className="flex justify-end gap-4 mt-6">
              <Button variant="outline" onClick={() => navigate('/adminmercado/ciclo-index')}>
                Voltar
              </Button>
              <TooltipProvider>
                <Tooltip>
      ...
      {/* Modal de confirmação quando excede o valor */}
      <AlertDialog open={showConfirmModal} onOpenChange={setShowConfirmModal}>
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>Confirmar Publicação</AlertDialogTitle>
            <AlertDialogDescription>
              O valor atual da cesta (R$ {valorAtual.toFixed(2).replace('.', ',')}) excede o valor máximo permitido 
              (R$ {ciclo.valorMaximo.toFixed(2).replace('.', ',')}). Deseja continuar mesmo assim?
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
