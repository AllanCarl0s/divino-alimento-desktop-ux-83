...
export default function AdminComposicaoLote() {
  ...
  const [ofertas] = useState<Oferta[]>([
    ...
    },
    {
      ...
      quantidadeDisponivel: 95,
      valorAcumulado: 75.00,
      certificacao: 'organico',
      tipo_agricultura: 'familiar',
    },
    {
