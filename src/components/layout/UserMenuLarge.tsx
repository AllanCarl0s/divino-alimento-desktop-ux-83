  ...
  return (
    <div ref={menuRef} className="relative">
      ...
      <button
        ...
        className="w-full mt-6 md:mt-8 flex items-center justify-start pl-4 md:justify-center md:pl-0 gap-1 focus:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 rounded-md transition-all hover:opacity-80"
